...
class DependencyResolveResult7<I1, I2, I3, I4, I5, I6, I7>
  ...
  const DependencyResolveResult7({
    required this.item1,
    required this.item2,
    required this.item3,
    required this.item4,
  ...
  DependencyResolveResult merge(DependencyResolveResult other) {
    if (other is DependencyResolveResult7<I1, I2, I3, I4, I5, I6, I7>) {
      return DependencyResolveResult7<I1, I2, I3, I4, I5, I6, I7>(
